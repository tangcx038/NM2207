...
#Problem Encounter 5
```{r}
knitr::include_graphics("problem5.png")
```
Overcome: Check the data and rearrange the data

#Problem Encounter 6
```{r}
knitr::include_graphics("problem10-problem pushign to ghithub.png")
```
Overcome: Reclone repository and redo the whole repository

#Problem Encounter 7
```{r}
knitr::include_graphics("problem11.jpg")
```
Overcome: Research more and edit code. 
